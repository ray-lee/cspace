        ...
        <table className="tabularcompoundinput">
          ...
          <tbody>
            <tr>
              ...
              <td><StaticControlledInput name="dateEarliestSingleEra" value={value.get('dateEarliestSingleEra')} controlledListName="dateEras" onCommit={this.handleInputCommit}/></td>
              <td><StaticControlledInput name="dateEarliestSingleCertainty" value={value.get('dateEarliestSingleCertainty')} controlledListName="dateCertainties" onCommit={this.handleInputCommit}/></td>
              ...
              <td><StaticControlledInput name="dateEarliestSingleQualifierUnit" value={value.get('dateEarliestSingleQualifierUnit')} controlledListName="dateUnits" onCommit={this.handleInputCommit}/></td>
            </tr>
            <tr>
              ...
              <td><StaticControlledInput name="dateLatestEra" value={value.get('dateLatestEra')} controlledListName="dateEras" onCommit={this.handleInputCommit}/></td>
              <td><StaticControlledInput name="dateLatestCertainty" value={value.get('dateLatestCertainty')} controlledListName="dateCertainties" onCommit={this.handleInputCommit}/></td>
              ...
              <td><StaticControlledInput name="dateLatestQualifierUnit" value={value.get('dateLatestQualifierUnit')} controlledListName="dateUnits" onCommit={this.handleInputCommit}/></td>
            </tr>
          </tbody>
        </table>
      </div>

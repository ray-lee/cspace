...
require('./TabbedPanelStack.css');

var TabbedPanelStack = React.createClass({
  propTypes: {
  ...
  handleTabClick: function(event) {
    ...
    var key = target.getAttribute('data-tabbedpanelstackkey');
  ...
  render: function() {
    ...
    var tabs = panelHeaders.map(function(panelHeader, index) {
      ...
      return(
        <div key={key} className={classes} data-tabbedpanelstackkey={key} onClick={this.handleTabClick}>
          {panelHeader}
        </div>
      );
    }, this);
    ...
    return (
      <div className="tabbedpanelstack">
...
module.exports = TabbedPanelStack;